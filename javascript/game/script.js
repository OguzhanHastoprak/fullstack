...
const locations = [
    {
        ...
        text: "You are in town sqaure. You see a sign that says \"Store\"."
    },
    {
        name: "store",
    ...
    },
    {
        ...
        text: "Monster died. You gain experience and gold."
    },
    {
        name: "lose",
...
function pick(guess){
    ...
    while (numbers.length < 10)
        numbers.push(Math.floor(random() * 11))
    text.innerText = "You picked " + guess + ". Random numbers are:\n";
    for(let i = 0; i<10; i++)
